...
extends BasePropertyConstants {
	...
	private static final String PARSING_TABLE_FACTORY_PREFIX
	= buildPropertyPrefix(ROOT_PREFIX, "parsingTableFactory");

	private static final String ACTIONS_PREFIX
	= buildPropertyPrefix(ROOT_PREFIX, "parser", "actions");
	...
	public static final String PARSING_TABLE_FACTORY_CLASS_NAME_PROPERTY
	= PARSING_TABLE_FACTORY_PREFIX + CLASS_NAME;
	
	public static final String PARSING_TABLE_FACTORY_FILLER_PREFIX
	= buildPropertyPrefix(PARSING_TABLE_FACTORY_PREFIX, "filler");
	
	public static final String PARSING_TABLE_FACTORY_FILLER_CLASSES_BASENAME_PROPERTY
	= PARSING_TABLE_FACTORY_FILLER_PREFIX + CLASSES_BASENAME;
