...
/**
 * Implementacija podakcije za tip {@link SubactionType#TOKENIZE}.
 * 
 * @author Leo Osvald
 *
 */
class TokenizeSubaction implements Subaction {
	...
	public void perform(Lexer lexer, Object... args) {
		lexer.tokenize((TokenType) args[0]);
	}
