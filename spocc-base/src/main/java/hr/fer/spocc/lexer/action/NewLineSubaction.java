...
/**
 * Implementacija podakcije za tip {@link SubactionType#NEW_LINE}.
 * 
 * @author Leo Osvald
 *
 */
class NewLineSubaction implements Subaction {

	@Override
	public SubactionType getType() {
		return SubactionType.NEW_LINE;
	}
